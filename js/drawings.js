...
const DRAWINGS = {
  ...
  { "action": "gesture", "color": "#1a1a1a", "width": 6, "points": [[0.23, 0.27], [0.48, 0.20]] },
  { "action": "gesture", "color": "#1a1a1a", "width": 6, "points": [[0.23, 0.42], [0.48, 0.35]] },
  { "action": "gesture", "color": "#1a1a1a", "width": 4, "points": [[0.28, 0.25], [0.28, 0.40]] },
  ...
  { "action": "gesture", "color": "#1a1a1a", "width": 4, "points": [[0.28, 0.50], [0.59, 0.44]] },
  ...
  { "action": "gesture", "color": "#1a1a1a", "width": 4, "points": [[0.43, 0.56], [0.74, 0.50]] },
...
parrot : [
  ...
  { "action": "gesture", "color": "#000000", "width": 5, "points": [[0.29, 0.14], [0.29, 0.19], [0.31, 0.23], [0.32, 0.25], [0.30, 0.26], [0.31, 0.28], [0.34, 0.27], [0.35, 0.25]] },
  { "action": "fill", "color": "#ff3838", "x": 0.31, "y": 0.21 },
  { "action": "gesture", "color": "#000000", "width": 4, "points": [[0.36, 0.13], [0.37, 0.11], [0.40, 0.10], [0.43, 0.12], [0.44, 0.15], [0.42, 0.18], [0.39, 0.18], [0.36, 0.16], [0.36, 0.13]] },
  { "action": "fill", "color": "#f9ca24", "x": 0.40, "y": 0.14 },
  { "action": "gesture", "color": "#000000", "width": 5, "points": [[0.38, 0.14], [0.39, 0.13], [0.41, 0.14], [0.41, 0.16], [0.39, 0.16], [0.38, 0.14]] },
  { "action": "fill", "color": "#1e272e", "x": 0.40, "y": 0.15 },
  ...
  { "action": "gesture", "color": "#000000", "width": 5, "points": [[0.44, 0.28], [0.42, 0.31], [0.40, 0.36], [0.40, 0.42], [0.44, 0.48], [0.50, 0.54], [0.56, 0.57], [0.63, 0.58], [0.68, 0.56]] },
  { "action": "gesture", "color": "#000000", "width": 4, "points": [[0.45, 0.31], [0.48, 0.30], [0.52, 0.32], [0.55, 0.36], [0.54, 0.42], [0.50, 0.46], [0.45, 0.45], [0.43, 0.40], [0.45, 0.31]] },
  { "action": "gesture", "color": "#000000", "width": 4, "points": [[0.47, 0.34], [0.50, 0.35], [0.51, 0.38], [0.49, 0.40], [0.46, 0.38]] },
  { "action": "fill", "color": "#7bed9f", "x": 0.48, "y": 0.38 },
  { "action": "fill", "color": "#26de81", "x": 0.60, "y": 0.45 },
  { "action": "gesture", "color": "#000000", "width": 5, "points": [[0.62, 0.58], [0.61, 0.66], [0.62, 0.76], [0.65, 0.86], [0.67, 0.95], [0.70, 0.95], [0.71, 0.86], [0.70, 0.74], [0.69, 0.64], [0.68, 0.56]] },
  { "action": "gesture", "color": "#000000", "width": 4, "points": [[0.62, 0.66], [0.65, 0.72], [0.65, 0.80], [0.67, 0.88]] },
  { "action": "fill", "color": "#10ac84", "x": 0.65, "y": 0.75 },
  { "action": "gesture", "color": "#000000", "width": 5, "points": [[0.50, 0.54], [0.48, 0.57], [0.43, 0.58], [0.45, 0.60], [0.49, 0.60], [0.52, 0.62], [0.53, 0.65], [0.51, 0.66], [0.47, 0.66], [0.53, 0.68], [0.55, 0.66], [0.54, 0.60], [0.56, 0.57]] }
],
telephone : [
  { "action": "gesture", "color": "#000000", "width": 6, "points": [[0.15, 0.35], [0.18, 0.55], [0.15, 0.78], [0.20, 0.83], [0.35, 0.83], [0.60, 0.83], [0.75, 0.83], [0.78, 0.78], [0.75, 0.55], [0.78, 0.35], [0.62, 0.22], [0.60, 0.17], [0.35, 0.17], [0.32, 0.22], [0.15, 0.35]] },
  { "action": "gesture", "color": "#000000", "width": 6, "points": [[0.15, 0.78], [0.18, 0.87], [0.32, 0.90], [0.62, 0.90], [0.75, 0.87], [0.78, 0.78]] },
  { "action": "fill", "color": "#74b9ff", "x": 0.50, "y": 0.50 },
  { "action": "fill", "color": "#0984e3", "x": 0.50, "y": 0.86 },
  { "action": "gesture", "color": "#000000", "width": 6, "points": [[0.04, 0.25], [0.04, 0.35], [0.15, 0.38], [0.28, 0.31], [0.26, 0.20], [0.32, 0.17], [0.62, 0.17], [0.68, 0.20], [0.65, 0.31], [0.78, 0.38], [0.89, 0.35], [0.89, 0.25], [0.75, 0.12], [0.60, 0.09], [0.35, 0.09], [0.18, 0.12], [0.04, 0.25]] },
  { "action": "fill", "color": "#0984e3", "x": 0.50, "y": 0.13 },
  { "action": "gesture", "color": "#000000", "width": 5, "points": [[0.78, 0.35], [0.85, 0.35], [0.93, 0.40], [0.95, 0.48], [0.92, 0.55], [0.86, 0.60], [0.78, 0.65]] },
  { "action": "gesture", "color": "#000000", "width": 4, "points": [[0.80, 0.35], [0.82, 0.38], [0.85, 0.43], [0.88, 0.48], [0.90, 0.54], [0.91, 0.58]] },
  { "action": "gesture", "color": "#000000", "width": 4, "points": [[0.83, 0.36], [0.85, 0.41], [0.88, 0.46], [0.89, 0.51], [0.89, 0.56]] },
  { "action": "gesture", "color": "#000000", "width": 4, "points": [[0.86, 0.38], [0.88, 0.44], [0.88, 0.50], [0.86, 0.55]] },
  { "action": "fill", "color": "#b2bec3", "x": 0.88, "y": 0.48 },
  { "action": "gesture", "color": "#000000", "width": 4, "points": [[0.32, 0.32], [0.40, 0.32], [0.40, 0.41], [0.32, 0.41], [0.32, 0.32]] },
  ...
  { "action": "gesture", "color": "#000000", "width": 4, "points": [[0.32, 0.43], [0.40, 0.43], [0.40, 0.51], [0.32, 0.51], [0.32, 0.43]] },
  ...
  { "action": "gesture", "color": "#000000", "width": 4, "points": [[0.32, 0.53], [0.40, 0.53], [0.40, 0.61], [0.32, 0.61], [0.32, 0.53]] },
  ...
  { "action": "gesture", "color": "#000000", "width": 4, "points": [[0.32, 0.63], [0.40, 0.63], [0.40, 0.71], [0.32, 0.71], [0.32, 0.63]] },
...
robot : [
  ...
  { "action": "fill", "color": "#a7f3d0", "x": 0.45, "y": 0.30 },
  ...
  { "action": "gesture", "color": "#000000", "width": 5, "points": [[0.30, 0.74], [0.35, 0.82], [0.55, 0.82], [0.60, 0.74]] },
  { "action": "fill", "color": "#a7f3d0", "x": 0.45, "y": 0.78 },
  { "action": "gesture", "color": "#000000", "width": 5, "points": [[0.35, 0.80], [0.30, 0.94], [0.22, 0.98], [0.36, 0.99], [0.35, 0.80]] },
  { "action": "gesture", "color": "#000000", "width": 5, "points": [[0.55, 0.80], [0.60, 0.94], [0.68, 0.98], [0.54, 0.99], [0.55, 0.80]] },
